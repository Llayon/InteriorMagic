...
export function WorkspaceSheet() {
  ...
  return <aside className="workspace-sheet" data-testid="workspace-sheet" data-sheet-state={sheetState} data-workspace-panel={panel ?? 'none'} onPointerDown={(event) => event.stopPropagation()}>
    ...
    <div className="sheet-content">{panel === 'materials' ? <Finishes /> : <Catalog />}</div>
  </aside>;
}
