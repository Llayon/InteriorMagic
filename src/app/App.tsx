...
export function App() {
  return <main data-testid="app-root"><header data-testid="app-header"><div><small>INTERIOR MAGIC</small><h1>Моя комната</h1></div><ProjectMenu /></header><div className="scene" data-testid="scene"><SceneCanvas /><div className="hint">Перетаскивайте мебель одним пальцем</div><Toolbar /><Finishes />{isDebugEnabled && <DebugOverlay />}</div><Catalog /></main>;
}
