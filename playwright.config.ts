...
export default defineConfig({
  ...
  testIgnore: /(?:ar0-production|mobile-showcase-product|showcase(?:-production)?|planner-(?:preview|integration|intent))\.spec\.ts/,
  fullyParallel: true,
  ...
  projects: [
    ...
    {
      name: 'mobile-small',
      testIgnore: /(?:ar0(?:-disabled|-production)?|mobile-showcase-product|planner-(?:preview|integration|intent)|showcase(?:-production)?)\.spec\.ts/,
