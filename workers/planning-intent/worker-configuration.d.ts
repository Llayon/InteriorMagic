/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/planning-intent/wrangler.jsonc --env-interface=PlanningIntentWorkerEnv workers/planning-intent/worker-configuration.d.ts` (hash: f4a03cd52c600c6eff8a95e1e8efa957)
// Runtime types generated with workerd@1.20260820.1 2026-08-24 nodejs_compat
interface __BaseEnv_PlanningIntentWorkerEnv {
...
declare namespace Cloudflare {
	...
	interface Env extends __BaseEnv_PlanningIntentWorkerEnv {}
}
interface PlanningIntentWorkerEnv extends __BaseEnv_PlanningIntentWorkerEnv {}
type StringifyValues<EnvType extends Record<string, unknown>> = {
	[Binding in keyof EnvType]: EnvType[Binding] extends string ? EnvType[Binding] : string;
};
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_ORIGIN" | "GROQ_API_KEY">> {}
}
