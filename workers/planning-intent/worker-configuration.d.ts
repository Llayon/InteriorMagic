/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=workers/planning-intent/wrangler.jsonc --env-interface=PlanningIntentWorkerEnv workers/planning-intent/worker-configuration.d.ts` (hash: b447d231f66f586533804986e62ab977)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GROQ_API_KEY">> {}
}
